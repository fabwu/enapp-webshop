...
public class ItemService extends Service {
    ...
    static {
        ITEMSERVICE_WSDL_LOCATION = ch.hslu.edu.enapp.webshop.webservice.ItemService.class
                .getResource("/META-INF/wsdl/ItemService.wsdl");
        WebServiceException e = null;
        if (ITEMSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException(
                    "Cannot find '/META-INF/wsdl/ItemService.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
