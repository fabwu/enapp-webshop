...
@XmlType(name = "Item", propOrder = { "key", "no", "description", "owner", "kind", "mediafileName", "manufacturerCode",
        "baseUnitOfMeasure", "billOfMaterials", "shelfNo", "automaticExtTexts", "createdFromNonstockItem",
        "itemCategoryCode", "productGroupCode", "lastDateModified", "searchDescription", "inventory",
        "qtyOnPurchOrder", "qtyOnProdOrder", "qtyOnComponentLines", "qtyOnSalesOrder", "qtyOnServiceOrder",
        "serviceItemGroup", "blocked", "noStockkeeping", "costingMethod", "costIsAdjusted", "costIsPostedToGL",
        "standardCost", "unitCost", "overheadRate", "indirectCostPercent", "lastDirectCost", "priceProfitCalculation",
        "profitPercent", "unitPrice", "genProdPostingGroup", "vatProdPostingGroup", "inventoryPostingGroup",
        "netInvoicedQty", "allowInvoiceDisc", "itemDiscGroup", "salesUnitOfMeasure", "saleBlocked",
        "replenishmentSystem", "vendorNo", "vendorItemNo", "purchUnitOfMeasure", "leadTimeCalculation",
        "manufacturingPolicy", "routingNo", "productionBOMNo", "roundingPrecision", "flushingMethod", "scrapPercent",
        "lotSize", "purchaseBlocked", "reorderingPolicy", "includeInventory", "reserve", "orderTrackingPolicy",
        "stockkeepingUnitExists", "critical", "reorderCycle", "safetyLeadTime", "safetyStockQuantity", "reorderPoint",
        "reorderQuantity", "maximumInventory", "minimumOrderQuantity", "maximumOrderQuantity", "orderMultiple",
        "tariffNo", "countryRegionOfOriginCode", "netWeight", "grossWeight", "itemTrackingCode", "serialNos", "lotNos",
        "expirationCalculation", "commonItemNo", "specialEquipmentCode", "putAwayTemplateCode",
        "putAwayUnitOfMeasureCode", "physInvtCountingPeriodCode", "lastPhysInvtDate", "lastCountingPeriodUpdate",
        "nextCountingPeriod", "identifierCode", "useCrossDocking" })
public class Item implements Serializable {
     ...
     *
     * @return possible object is {@link CostingMethod }
     * 
     */
     ...
     *
     * @param value allowed object is {@link CostingMethod }
     * 
     */
     ...
     *
     * @return possible object is {@link PriceProfitCalculation }
     * 
     */
     ...
     *
     * @param value allowed object is {@link PriceProfitCalculation }
     * 
     */
     ...
     *
     * @return possible object is {@link ReplenishmentSystem }
     * 
     */
     ...
     *
     * @param value allowed object is {@link ReplenishmentSystem }
     * 
     */
     ...
     *
     * @return possible object is {@link ManufacturingPolicy }
     * 
     */
     ...
     *
     * @param value allowed object is {@link ManufacturingPolicy }
     * 
     */
     ...
     *
     * @return possible object is {@link FlushingMethod }
     * 
     */
     ...
     *
     * @param value allowed object is {@link FlushingMethod }
     * 
     */
     ...
     *
     * @return possible object is {@link ReorderingPolicy }
     * 
     */
     ...
     *
     * @param value allowed object is {@link ReorderingPolicy }
     * 
     */
     ...
     *
     * @return possible object is {@link Reserve }
     * 
     */
     ...
     *
     * @param value allowed object is {@link Reserve }
     * 
     */
     ...
     *
     * @return possible object is {@link OrderTrackingPolicy }
     * 
     */
     ...
     *
     * @param value allowed object is {@link OrderTrackingPolicy }
     * 
     */
    ...
    public String toString() {
        return "Item [key=" + key + ", no=" + no + ", description=" + description + ", owner=" + owner + ", kind="
                + kind + ", mediafileName=" + mediafileName + ", manufacturerCode=" + manufacturerCode
                + ", baseUnitOfMeasure=" + baseUnitOfMeasure + ", billOfMaterials=" + billOfMaterials + ", shelfNo="
                + shelfNo + ", automaticExtTexts=" + automaticExtTexts + ", createdFromNonstockItem="
                + createdFromNonstockItem + ", itemCategoryCode=" + itemCategoryCode + ", productGroupCode="
                + productGroupCode + ", lastDateModified=" + lastDateModified + ", searchDescription="
                + searchDescription + ", inventory=" + inventory + ", qtyOnPurchOrder=" + qtyOnPurchOrder
                + ", qtyOnProdOrder=" + qtyOnProdOrder + ", qtyOnComponentLines=" + qtyOnComponentLines
                + ", qtyOnSalesOrder=" + qtyOnSalesOrder + ", qtyOnServiceOrder=" + qtyOnServiceOrder
                + ", serviceItemGroup=" + serviceItemGroup + ", blocked=" + blocked + ", noStockkeeping="
                + noStockkeeping + ", costingMethod=" + costingMethod + ", costIsAdjusted=" + costIsAdjusted
                + ", costIsPostedToGL=" + costIsPostedToGL + ", standardCost=" + standardCost + ", unitCost="
                + unitCost + ", overheadRate=" + overheadRate + ", indirectCostPercent=" + indirectCostPercent
                + ", lastDirectCost=" + lastDirectCost + ", priceProfitCalculation=" + priceProfitCalculation
                + ", profitPercent=" + profitPercent + ", unitPrice=" + unitPrice + ", genProdPostingGroup="
                + genProdPostingGroup + ", vatProdPostingGroup=" + vatProdPostingGroup + ", inventoryPostingGroup="
                + inventoryPostingGroup + ", netInvoicedQty=" + netInvoicedQty + ", allowInvoiceDisc="
                + allowInvoiceDisc + ", itemDiscGroup=" + itemDiscGroup + ", salesUnitOfMeasure=" + salesUnitOfMeasure
                + ", saleBlocked=" + saleBlocked + ", replenishmentSystem=" + replenishmentSystem + ", vendorNo="
                + vendorNo + ", vendorItemNo=" + vendorItemNo + ", purchUnitOfMeasure=" + purchUnitOfMeasure
                + ", leadTimeCalculation=" + leadTimeCalculation + ", manufacturingPolicy=" + manufacturingPolicy
                + ", routingNo=" + routingNo + ", productionBOMNo=" + productionBOMNo + ", roundingPrecision="
                + roundingPrecision + ", flushingMethod=" + flushingMethod + ", scrapPercent=" + scrapPercent
                + ", lotSize=" + lotSize + ", purchaseBlocked=" + purchaseBlocked + ", reorderingPolicy="
                + reorderingPolicy + ", includeInventory=" + includeInventory + ", reserve=" + reserve
                + ", orderTrackingPolicy=" + orderTrackingPolicy + ", stockkeepingUnitExists=" + stockkeepingUnitExists
                + ", critical=" + critical + ", reorderCycle=" + reorderCycle + ", safetyLeadTime=" + safetyLeadTime
                + ", safetyStockQuantity=" + safetyStockQuantity + ", reorderPoint=" + reorderPoint
                + ", reorderQuantity=" + reorderQuantity + ", maximumInventory=" + maximumInventory
                + ", minimumOrderQuantity=" + minimumOrderQuantity + ", maximumOrderQuantity=" + maximumOrderQuantity
                + ", orderMultiple=" + orderMultiple + ", tariffNo=" + tariffNo + ", countryRegionOfOriginCode="
                + countryRegionOfOriginCode + ", netWeight=" + netWeight + ", grossWeight=" + grossWeight
                + ", itemTrackingCode=" + itemTrackingCode + ", serialNos=" + serialNos + ", lotNos=" + lotNos
                + ", expirationCalculation=" + expirationCalculation + ", commonItemNo=" + commonItemNo
                + ", specialEquipmentCode=" + specialEquipmentCode + ", putAwayTemplateCode=" + putAwayTemplateCode
                + ", putAwayUnitOfMeasureCode=" + putAwayUnitOfMeasureCode + ", physInvtCountingPeriodCode="
                + physInvtCountingPeriodCode + ", lastPhysInvtDate=" + lastPhysInvtDate + ", lastCountingPeriodUpdate="
                + lastCountingPeriodUpdate + ", nextCountingPeriod=" + nextCountingPeriod + ", identifierCode="
                + identifierCode + ", useCrossDocking=" + useCrossDocking + "]";
    }
